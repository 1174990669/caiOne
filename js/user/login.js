  ...
  loginObj.getMsg = function () { //
      if ($('#regist_updateMsg').hasClass('alreadysend')) return;
        ...
        console.log(userName)
        Global.post('?m=cashier.excep.ali_message', {mobile: userName}, function (req) {
            console.log(req);
...
//    //console.log(ConfigObj.localSite + "?m=user.account.login");
    ...
    // console.log(secretData) 
    $.ajax({
      url : ConfigObj.localSite + "?m=cashier.excep.login_message",
...
//      obj.info = $.parseJSON(Global.crypt(obj.info));
    if(obj.code == 0){
      ...
      obj.info = $.parseJSON(Global.crypt(obj.info));
          ...
          // console.log(obj.info.image)
          // console.log(obj.info.info.image)
          nam_Img = obj.info.info.image
          // console.log(nam_Img)
          // loginObj.subImg(nam_Img)
          localStorage.setItem("lastname", nam_Img);
          
          // console.log($('.div-back1'))
      ...
      // console.log(obj.info.token.access_token)
 ...
 //self.createWid();  goForward
  ...
  this.findPwd.unbind('tap').tap(function(){
    ...
    findPwdObj.show(true,function(){
      ...
      // 微信登录 socialAuth cashier.excep.login_message
      $('#login_wxlogin').on('tap', function () {
        console.log('微信登录')
          ...
          if (ConfigObj.platForm === 'android') {
            // console.log(auth)
            console.log(loginObj.social.wx[1])
          ...
          success: function (obj) {
              if (obj.code == '0000') {
               ...
               console.log(obj.info)
                  ...
                  loginObj.goForward();
                  // console.log(loginObj.goForward())
...
//       //console.log('设置clientid',obj);
  ...
  loginObj.goForward = function(){console.log(527)}
