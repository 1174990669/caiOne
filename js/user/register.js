	...
	registerObj.createEvent = function(){
        ...
        $('#login_wx').on('tap', function () {
            // loginObj.setSocialLogin();register_updateMsg
        // console.log('微信登录')
          var $img = $('#login_wx img');
          ...
          setTimeout(function () {userCenterObj.show()},5000);
          // console.log(auth)
      });
